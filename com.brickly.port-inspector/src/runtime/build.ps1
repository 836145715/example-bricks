# Build Port Inspector Go runtime.
...
$srcDir = "$PSScriptRoot"
$runtimeRoot = "$PSScriptRoot\..\..\out\runtime"
...
try {
  foreach ($key in $Targets) {
    ...
    $outDir = if ($env:BRICKLY_BUILD_OUT) { $env:BRICKLY_BUILD_OUT } else { "$PSScriptRoot\..\..\out\runtime\$key" }
