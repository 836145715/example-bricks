...
/** 自绘标题栏：拖动区 + 最小化 / 最大化 / 关闭（titleBar=custom 注入 window.brickly.window）。 */
  ...
  return (
    <header className="titlebar" aria-label="窗口标题栏">
      <div className="titlebar-drag">
        ...
        <span className="titlebar-title">闪电搜索</span>
        <span className="titlebar-id">{window.brickly?.ref?.brickId ?? 'com.brickly.flash-find'}</span>
      </div>
