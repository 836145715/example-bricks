...
func init() {
	registerMCPOps("rules", map[string]mcpOpHandler{
		"config_get_replace": func(app MCPCore, args map[string]any) (any, error) {
			return replaceRulesSnapshot(app, false, false), nil
		},
		"config_set_replace": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
		...
		"config_get_rewrite": func(app MCPCore, args map[string]any) (any, error) {
			return replaceRulesSnapshot(app, false, true), nil
		},
		"config_set_rewrite": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
			rules, err := parseReplaceRulesJSON(argString(a, "rulesJSON"))
			if err != nil {
				return nil, err
		...
		"config_get_intercept": func(app MCPCore, args map[string]any) (any, error) {
			return replaceRulesSnapshot(app, true, false), nil
		},
		"config_set_intercept": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
			rules, err := parseReplaceRulesJSON(argString(a, "rulesJSON"))
			if err != nil {
				return nil, err
		...
		"config_rule_set_state": func(app MCPCore, args map[string]any) (any, error) {
			return bridgeConfigRuleSetState(app, argsMap(args))
		},
		"config_get_block": func(app MCPCore, args map[string]any) (any, error) {
			return map[string]any{"rules": []any{}, "total": 0}, nil
		},
		"config_set_block": func(app MCPCore, args map[string]any) (any, error) {
			emitMCPConfigReload("block")
			return map[string]any{"ok": true}, nil
		},
		"config_get_host": func(app MCPCore, args map[string]any) (any, error) {
			return hostRulesSnapshot(app), nil
		},
		"config_set_host": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
		...
		"config_host_add": func(app MCPCore, args map[string]any) (any, error) {
			return bridgeHostAdd(app, argsMap(args))
		},
		"config_host_delete": func(app MCPCore, args map[string]any) (any, error) {
			return bridgeHostDelete(app, argsMap(args))
		},
		"config_host_update": func(app MCPCore, args map[string]any) (any, error) {
