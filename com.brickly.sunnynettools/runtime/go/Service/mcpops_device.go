...
func init() {
	registerMCPOps("device", map[string]mcpOpHandler{
		"device_status": func(app MCPCore, args map[string]any) (any, error) {
			return map[string]any{
				"isWindows":    runtime.GOOS == "windows",
				"deviceLoaded": app.IsLoadDevice(),
			}, nil
		},
		"device_load": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
		...
		"device_process_add_name": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
		...
		"device_process_del_name": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
			name := argString(a, "name")
		...
		"device_process_add_pid": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
			pid := argInt(a, "pid", 0)
		...
		"device_process_del_pid": func(app MCPCore, args map[string]any) (any, error) {
			a := argsMap(args)
			pid := argInt(a, "pid", 0)
		...
		"device_process_cancel_all": func(app MCPCore, args map[string]any) (any, error) {
