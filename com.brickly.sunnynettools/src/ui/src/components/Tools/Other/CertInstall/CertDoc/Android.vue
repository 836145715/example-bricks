<template>
  ...
  <div class="demo-collapse" style="">
    <el-collapse accordion>
      <el-collapse-item title="(安装前需检查的信息)必要步骤" name="00">
        <el-tag class="ml-2" type="danger">必要 步骤1：</el-tag>
        <el-tag class="ml-2" type="info">确认手机与电脑在同一局域网</el-tag>
        <br>
        <el-tag class="ml-2" type="danger">必要 步骤2：</el-tag>
        <el-tag class="ml-2" type="info">确认电脑已关闭防火墙、或已设置防火墙相关规则</el-tag>
        <br>
        <img :src="Image18"/>
        <br>
        <el-tag class="ml-2" type="danger">必要 步骤3：</el-tag>
        <el-tag class="ml-2" type="info">检查手机时间是否正确</el-tag>
        <br>
      </el-collapse-item>
      <el-collapse-item title="一键自动安装(通用方式)" name="0">
        <el-text class="mx-1" type="success">推荐使用：</el-text>&nbsp;
        <el-tooltip
            class="box-item"
            effect="dark"
            content="点击去下载"
            placement="top"
        >
          <el-text class="mx-1" type="danger" @click="callUrl('https://wwf.lanzouj.com/b0cj3pgcd','1z4t')"
                   style="cursor: pointer; text-decoration: underline;">证书安装工具下载
          </el-text>
        </el-tooltip>
      </el-collapse-item>
